...
export default function Page() {
  const projects = [
    {
      title: "PUI - pueue dashboard",
      subtitle: "End‑to‑end product design",
      imageSrc: "/images/pui.png",
            ...
            >
              ...
              <div>
                ...
                <div className="mb-8 flex items-center gap-2">
                  <div className="text-2xl font-extrabold tracking-tight">noah</div>
                ...
                <AnimatedHeading
                  ...
                  lines={["I write Software,", "you can do too."]}
                />

                <p className="mt-4 max-w-[42ch] text-lg text-white/70">
                  I'm a Student from Germany, creating open source software because I feel like it.
                </p>
